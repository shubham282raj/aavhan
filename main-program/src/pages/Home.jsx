...
export default function Home() {
  ...
  return (
    <div className="">
      ...
      <div
        id="aboutus"
        className="w-screen min-h-screen flex flex-col justify-center items-center pt-28 pb-16"
      >
        <div className="text-white text-3xl my-5">About Us</div>
        <div className="flex flex-col md:flex-row max-w-screen-lg justify-center md:items-center gap-5 mx-10">
          <div className="flex-1 flex-shrink-0 w-[80vw] max-w-md mx-auto">
            {/* <ImageSliderLoaders
          ...
          <div className="text-white px-10 flex-1 flex-shrink-0 space-y-5">
            ...
            <div className="flex justify-between max-w-screen-sm w-full px-10">
      ...
      <div
        id="mainfest"
        className="w-screen min-h-screen flex flex-col justify-center items-center bg-black bg-opacity-30 px-4 pt-28 pb-16"
      >
        ...
        <div className="flex flex-col sm:flex-row flex-co gap-5 flex-wrap justify-center items-center py-2">
          {mainFestSheet.map((element, index) => (
            <div className="text-white sm:w-[40%] w-[80%] bg-white bg-opacity-10 flex flex-col gap-2 rounded-md py-3 px-3 text-center">
      ...
      <div className="w-screen min-h-screen relative flex flex-col gap-5 justify-center items-center">
        ...
        <div className="flex gap-5">
          {contactUs.map((element, index) => (
            <button className="p-1.5 text-white flex justify-center items-center group relative bg-white bg-opacity-20 rounded-lg">
      ...
      <div className="bg-black w-full min-h-72 py-10 flex flex-col justify-end gap-10 md:px-10">
        <div className="flex flex-col sm:flex-row justify-center items-center gap-8 max-w-screen-md mx-auto">
