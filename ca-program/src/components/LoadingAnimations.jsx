  ...
  return (
    <div className="flex flex-col justify-center items-center gap-2 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 select-none">
      <div className="flex space-x-2 justify-center items-center">
        <div className="h-5 aspect-square bg-slate-800 rounded-full animate-custom-bounce [animation-delay:-0.3s]"></div>
        <div className="h-5 aspect-square bg-slate-800 rounded-full animate-custom-bounce [animation-delay:-0.15s]"></div>
        <div className="h-5 aspect-square bg-slate-800 rounded-full animate-custom-bounce"></div>
      </div>
      <span className="text-slate-800 font-bold text-xl">Loading</span>
    </div>
  );
};
