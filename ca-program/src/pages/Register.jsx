...
export default function Register() {
  ...
  return (
    <form
      className=" bg-black bg-opacity-5 text-slate-800 flex flex-col gap-4 mx-3 sm:mx-auto py-10 px-6 sm:px-10 rounded-2xl max-w-screen-md my-[100px] shadow-inner backdrop-blur-[2px]"
      onSubmit={onSubmit}
    >
